package com.me.user_management_system.serviceImpl;
...
import com.me.user_management_system.repository.UserRepo;
...
public class UserServiceImpl implements UserService 
{
	...
	public ResponseEntity<ResponseStructure<UserResponse>> addUser(UserRequest userRequest) 
	{
		...
		responseStructure.setMessage("user added & it's successfully saved");
